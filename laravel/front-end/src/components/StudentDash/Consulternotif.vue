<template>
  ...
  export default {
    data() {
      return {
        notifications: [
          { title: "Nouvelle offre de stage", message: "Une nouvelle offre de stage est disponible. Consultez-la dès maintenant !" },
          { title: "Rappel: Date limite de candidature", message: "La date limite de candidature pour le stage X est le 30 avril. Assurez-vous de soumettre votre candidature à temps !" }
